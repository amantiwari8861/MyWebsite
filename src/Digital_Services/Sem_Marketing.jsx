...
const Sem_Marketing = () => {
  ...
  const fetchPageData = async () => {
    try {
      const res = await apiService.getSoftwarePageData('sem');
      setData(res.data);
    } catch (error) {
      console.error("Error fetching SEM page data:", error);
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="bg-[#05070F] text-white overflow-hidden">
      ...
      <div className="fixed inset-0 -z-10">
        <div className="absolute w-[600px] h-[600px] bg-cyan-500/20 blur-[160px] top-[-150px] left-[-150px]" />
          ...
          <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-20 items-center">
            ...
            <div className="relative" data-aos="fade-up">
              <img
                ...
                className="rounded-2xl shadow-[0_30px_100px_rgba(34,211,238,0.3)] w-full h-auto object-cover"
                alt="SEM"
              />
              ...
              <div className="absolute -bottom-8 -left-8 bg-white/5 backdrop-blur-xl border border-white/10 p-6 rounded-2xl">
                ...
                <h3 className="text-xl font-bold text-cyan-400">+120%</h3>
              </div>
            </div>
          </div>
        </section>
      ...
      <section className="py-32 max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-10">
          {services.map((item, i) => (
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-r from-cyan-500/0 via-cyan-500/20 to-blue-400/0 opacity-0 group-hover:opacity-100 blur-xl transition"></div>

              <div className="relative z-10">
                <div className="text-cyan-400 mb-4 group-hover:scale-110 transition">
                  {iconMap[item.icon] || <MousePointer2 />}
                </div>
      ...
      {cta && (
        <section className="py-32 text-center">
          ...
          <a 
            ...
            className="px-10 py-4 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-400 font-semibold hover:scale-105 transition shadow-lg inline-block"
          >
            {cta.button_text}
          </a>
        </section>
