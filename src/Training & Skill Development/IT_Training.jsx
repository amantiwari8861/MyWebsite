...
const IT_Training = () => {
  ...
  const fetchPageData = async () => {
    try {
      const res = await apiService.getTrainingPageData('it_training');
      setData(res.data);
    } catch (error) {
      console.error("Error fetching IT training page data:", error);
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="bg-[#05070F] text-white overflow-hidden">
      ...
      <div className="fixed inset-0 -z-10">
        <div className="absolute w-[600px] h-[600px] bg-emerald-500/20 blur-[160px] top-[-150px] left-[-150px]" />
        <div className="absolute w-[600px] h-[600px] bg-green-500/20 blur-[160px] bottom-[-150px] right-[-150px]" />
      </div>
          ...
          <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-20 items-center">
            ...
            <div data-aos="fade-up">
              ...
              <div className="flex gap-4">
                ...
                >
                  <span className="absolute inset-0 bg-gradient-to-r from-emerald-500 to-green-500"></span>
            ...
            <div className="relative" data-aos="fade-up">
              <img
                ...
                className="rounded-2xl shadow-[0_30px_100px_rgba(16,185,129,0.3)] w-full h-auto object-cover"
                alt="IT Training"
              />

              {/* FLOAT CARD */}
              <div className="absolute -bottom-8 -left-8 bg-white/5 backdrop-blur-xl border border-white/10 p-6 rounded-2xl">
                <p className="text-sm text-gray-400">Excellence</p>
                <h3 className="text-xl font-bold text-emerald-400">Guaranteed</h3>
              </div>
            </div>
          </div>
        </section>
      ...
      <section className="py-32 max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-10">
          {modules.map((item, i) => (
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-r from-emerald-500/0 via-emerald-500/20 to-green-400/0 opacity-0 group-hover:opacity-100 blur-xl transition"></div>

              <div className="relative z-10">
                <div className="text-emerald-400 mb-4 group-hover:scale-110 transition">
                  {iconMap[item.icon] || <Code />}
                </div>
      ...
      {cta && (
        <section className="py-32 text-center">
          ...
          <a 
            ...
            className="px-10 py-4 rounded-xl bg-gradient-to-r from-emerald-500 to-green-500 font-semibold hover:scale-105 transition shadow-lg inline-block"
          >
            {cta.button_text}
          </a>
        </section>
