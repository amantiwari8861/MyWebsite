      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-5">
          ...
          <p className="text-gray-400 text-base">
            At <span className="text-white font-semibold">{banner.company_name}</span>, we empower businesses with innovation and technology.
          </p>
        ...
        <div className="relative">
          ...
          <img
            src={banner.image || "https://placehold.co/800x600/1f2937/ffffff?text=Banner+Image"}
            alt={banner.title || "Banner"}
            className="relative w-full h-80 md:h-96 object-cover rounded-2xl shadow-2xl border border-gray-700"
            onError={(e) => {
              e.target.src = "https://placehold.co/800x600/1f2937/ffffff?text=Banner+Image";
            }}
          />
        </div>
