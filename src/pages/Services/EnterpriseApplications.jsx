...
import { Layers, ShieldCheck, Monitor, Target, ArrowRight, Star } from "lucide-react";
import AOS from "aos";
...
const EnterpriseApplications = () => {
  ...
  const benefits = [
    "Robust architecture for large-scale operations",
    ...
    <div className="min-h-screen bg-slate-50 pt-28 pb-20">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <div data-aos="fade-right">
            ...
            <h1 className="text-5xl lg:text-6xl font-black text-slate-900 leading-tight mb-6">
              Scale your business with <span className="text-blue-600">enterprise-grade apps</span>
            </h1>
            <p className="text-slate-600 text-xl leading-relaxed mb-8 max-w-2xl">
              Build secure, high-performance enterprise applications that connect teams, data, and processes across your organization.
            </p>
            ...
            <div className="bg-gradient-to-br from-blue-100 to-indigo-100 rounded-3xl p-8 shadow-2xl">
              ...
              <div className="absolute -bottom-4 -right-4 bg-white rounded-2xl p-4 shadow-xl">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-bold text-slate-900">Enterprise Ready</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {benefits.map((item, index) => (
              ...
              >
                ...
                <p className="text-slate-600">We build enterprise apps that streamline operations and keep your data secure.</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 px-6 bg-slate-900 text-white">
        <div className="max-w-4xl mx-auto text-center" data-aos="fade-up">
          <h2 className="text-4xl lg:text-5xl font-black mb-6">Modern enterprise apps for modern business</h2>
          <p className="text-slate-300 text-xl mb-10">
            Our team delivers integrations, analytics, and custom workflows for organizations that need dependable enterprise software.
          </p>
          <Link
            to="/contact-us"
